            ...
            <div class="grid grid-cols-12 gap-4">
                ...
                <div class="col-span-12 md:col-span-6 lg:col-span-8">
                    ...
                    <div class="grid grid-cols-12 gap-4">
                        ...
                        <a href="{{route('tienda.addCarrito', $product)}}" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Añadir al carrito" class="@if ($product->cantidad==0) pointer-events-none @endif col-span-12 md:col-span-6 lg:col-span-5 text-xl border-2 rounded p-3 mt-3 text-center text-gray-500 transition ease-in-out duration-700 hover:text-green-500 focus:ring-2 focus:outline-none focus:ring-green-500">
                            <i class="fa-solid fa-cart-plus"></i> Añadir al carrito
                        </a>

                        <a href="{{route('tienda.comprarProducto', $product)}}" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Comprar Producto" class="@if ($product->cantidad==0) pointer-events-none @endif col-span-12 md:col-span-12 lg:col-span-6 text-xl border-2 border-blue-300 rounded p-3 mt-3 text-center bg-blue-500 transition ease-in-out duration-500 hover:bg-blue-700 focus:ring-2 focus:outline-none focus:ring-blue-300 text-white">
                            @if ($product->cantidad==0) Agotado @else Comprar @endif
                        </a>
