...
@section('contenido')
    <div class="bg-gray-200 rounded py-4 my-4 px-2 w-2/4 mx-auto">
        ...
        <div id="default-carousel" class="relative" data-carousel="static">
            ...
            <div class="overflow-hidden relative h-56 rounded-lg sm:h-64 xl:h-80 2xl:h-96">
                ...
                <div class="hidden duration-700 ease-in-out" data-carousel-item="active">
                    <span class="absolute top-1/2 left-1/2 text-2xl font-semibold text-white -translate-x-1/2 -translate-y-1/2 sm:text-3xl"></span>
        ...
        <div class="p-5">
            ...
            class="bg-orange-500 hover:bg-orange-700 focus:ring-4 focus:outline-none focus:ring-orange-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center text-white">
