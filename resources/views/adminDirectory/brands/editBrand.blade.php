        ...
        <form action="{{ route('brands.update', compact('brand')) }}" method="POST">
            ...
            <div>
                ...
                <input type="text" name="nombre" id="tit"
                    ...
                    placeholder="Nombre" value="{{$brand->nombre}}" required>
                @error('nombre')
            ...
            <div class="mt-2">
                ...
                <textarea name="descripcion" id="cont"
                    class="px-2 py-2 focus:ring-indigo-500 focus:border-indigo-500 block w-full  sm:text-sm border-gray-300 rounded-md">{{$brand->descripcion}}</textarea>
                @error('descripcion')
                    <p class="text-sm text-orange-900 mt-1">*** {{ $message }}</p>
                @enderror
            </div>
            ...
            <div class="mt-2">
                <button type="submit" class="bg-green-500 hover:bg-green-700 text-white font-bold py-2 px-4 rounded"><i class="fas fa-save"></i> Actualizar</button>
