        ...
        <form action="{{ route('brands.update', compact('brand')) }}" method="POST">
            ...
            <div class="py-4 px-2 w-3/4 mx-auto border-black border-2 rounded-lg">
                ...
                <div class="relative z-0 w-full mb-6 group">
                    <input type="text" name="nombre" id="nombre" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " value="{{$brand->nombre}}" />
                ...
                <div class="relative z-0 w-full mb-6 group">
                    ...
                    <textarea id="descripcion" name="descripcion" rows="4" class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500">{{$brand->descripcion}}</textarea>
