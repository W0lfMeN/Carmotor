            ...
            <form action="{{route('contacto.procesar')}}" method="POST">
                ...
                <div class="py-4 px-2 w-3/4 mx-auto border-black border-2 rounded-lg">
                    ...
                    <div class="relative z-0 w-full mb-6 group">
                        <input type="text" name="nombre" id="nombre" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " @if (Auth::check()) value="{{auth::user()->name}}" readonly @endif />
                    ...
                    <div class="relative z-0 w-full mb-6 group">
                        <label for="mensaje" class="block mb-2 text-sm font-medium text-gray-900">Indicanos el motivo de tu consulta</label>
                        <textarea id="mensaje" name="mensaje" rows="4" class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500"></textarea>
                    ...
                    <div class="mt-10">
                        <button type="submit" class="text-white bg-green-500 hover:bg-green-700 focus:ring-4 focus:outline-none focus:ring-green-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center"><i class="fas fa-paper-plane"></i> Enviar</button>
                        <a href="{{ route('index') }}" class="bg-orange-500 hover:bg-orange-700 mx-4 focus:ring-4 focus:outline-none focus:ring-orange-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center text-white"><i class="fas fa-backward"></i> Regresar</a>
                    </div>
                </div>
